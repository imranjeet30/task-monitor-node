...
console.log(req.body);
    return Task.create({
        ...
        .then((task) => res.status(200).send({message:"Task has been created successfully"}))
...
router.get('/', function (req, res) {
    ...
    router.get('/:id', function (req, res) {
        Task.findById(req.params.id, { attributes: ['id', 'user_id', 'project_id', 'category_id', 'title', 'completion_date'] },).
